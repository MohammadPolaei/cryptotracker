...
export default function ContactForm() {
	return (
		<div className="w-full desktop:w-148.25 h-127.75 rounded-md border border-(--border-color) shadow-sm shadow-black/4 flex flex-col justify-between items-center p-2">
